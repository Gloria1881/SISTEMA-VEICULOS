...
public class MarcaMenu {
    ...
    private void exibir() {
        ...
        do {
           ...
           if (opcao == 11) {
            // Cria novo objeto Marca e atribui código automaticamente
            Marca marca = new Marca();
            marca.setCodigo(bancoMarcas.gerarCodigo()); // gera automático a partir de 100
            ...
            Marca marca = new Marca();
            System.out.println("Digite o código da marca para alterar:");
