...
public class MarcaMenu {
    ...
    //metodo construtor
    public MarcaMenu(Scanner teclado) {
    ...
    private void exibir() {
        ...
        do {
           ...
           if (opcao == 11) {
            ...
            teclado.nextLine(); // consumir newline antes de ler strings
            ...
            System.out.print("Digite o código da marca para alterar: ");
            marca.setCodigo(teclado.nextInt());
            teclado.nextLine(); // consumir newline
          
            System.out.print("Digite o novo nome da marca: ");
            marca.setNome(teclado.nextLine());

            System.out.print("Digite a nova sigla da marca: ");
            marca.setSigla(teclado.nextLine());

            bancoMarcas.alterar(marca);
